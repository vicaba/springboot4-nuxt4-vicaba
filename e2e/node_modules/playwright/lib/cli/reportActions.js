...
async function mergeReports(reportDir, opts) {
  ...
  const config = configFile
    ? await import_common.configLoader.loadConfigFromFile(configFile)
    : await import_common.configLoader.loadEmptyConfigForMergeReports();
  ...
  const result = await import_runner.merge.createMergedReport(
    config,
    dir,
