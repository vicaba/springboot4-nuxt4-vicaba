import { O as e } from "./defaultSettingsView-B-dXF5JN.js";
var t = e((e, t) => {
    (function (n, r) {
                    ...
                    for (let N = 0; N < x; N++) {
                      ...
                      switch (
                        (this._decorationService.forEachDecorationAtCell(
                          ...
                          void 0,
                          (e) => {
                            (e.options.layer !== `top` && X) ||
                              (e.backgroundColorRGB &&
                                ((G = 50331648),
                                (W =
                                  (e.backgroundColorRGB.rgba >> 8) & 16777215),
                                (q = e.backgroundColorRGB)),
                              e.foregroundColorRGB &&
                                ((U = 50331648),
                                (H =
                                  (e.foregroundColorRGB.rgba >> 8) & 16777215),
                                (J = e.foregroundColorRGB)),
                              (X = e.options.layer === `top`));
                          },
                        ),
                        !X &&
                          L &&
                          ((q = this._coreBrowserService.isFocused
                          ...
                          y.selectionForeground &&
                            ...
                            (J = y.selectionForeground))),
                        X && j.push(`xterm-decoration-top`),
                        G)
                      ) {
                        case 16777216:
                        case 33554432:
                          ((Y = y.ansi[W]), j.push(`xterm-bg-${W}`));
                          break;
                        case 50331648:
                          ((Y = l.channels.toColor(
                            W >> 16,
                            (W >> 8) & 255,
                            255 & W,
                          )),
                      ...
                      switch (
                        (q ||
                          (I.isDim() && (q = l.color.multiplyOpacity(Y, 0.5))),
                        U)
                      ) {
                        case 16777216:
                        case 33554432:
                        ...
                        case 50331648:
                          ...
                          this._applyMinimumContrast(b, Y, e, I, q, J) ||
                            this._addStyle(
                              b,
                  ...
                  for (; n >= t; ) {
                    ...
                    if (i > e) n = r - 1;
                      ...
                      if (!(i < e)) {
                        for (
                          ;
                          r > 0 && this._getKey(this._array[r - 1]) === e;
                        )
                          r--;
                        return r;
                      }
...
`,
  ...
  r = t(),
  i = n(),
  a = { Terminal: r.Terminal, FitAddon: i.FitAddon };
export { a as default };
