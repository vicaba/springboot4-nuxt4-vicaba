...
async function readEndpoint(userDataDir) {
  let contents;
  try {
    contents = await import_fs.default.promises.readFile(
      import_path.default.join(userDataDir, "DevToolsActivePort"),
      "utf-8",
    );
  } catch {
    return void 0;
  ...
  if (!Number.isFinite(port)) return void 0;
  if (!(await isPortOpen(port))) return void 0;
...
const channelToUserDataDir = /* @__PURE__ */ new Map([
  [
    "chrome",
    {
      linux: import_path.default.join(
        import_os.default.homedir(),
        ".config",
        "google-chrome",
      ),
      darwin: import_path.default.join(
        import_os.default.homedir(),
        "Library",
        "Application Support",
        "Google",
      ...
      win32: import_path.default.join(
